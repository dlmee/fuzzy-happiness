...
class GENP:
    ...
    def make_message(self, lang1, lang2, data):
        ...
        core = f"Your turn! Please analyze this {lang1} group of words: {data}\nRemember to always respond in JSON. Always return at least one stem, one proper noun assessment, a list of stopwords (even if it is empty), and one definition per stem, and always return each word form mapped to one stem."
