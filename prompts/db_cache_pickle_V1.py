...
class Cache:
    ...
    def cached_function(self, func=None, threshold_time=0.005):
        if func is None:
            def decorator(inner_func):
                return self.cached_function(inner_func, threshold_time)
            return decorator
    ...
    def cache_class_methods(self, cls, threshold_time=0.005):
        ...
        if hasattr(cls, '__call__'):
            setattr(cls, '__call__', self.cached_function(cls.__call__, threshold_time))
        return cls
